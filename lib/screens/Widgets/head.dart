...
import 'package:knu_app/screens/Widgets/seeTheMarkOfStudents.dart';
import 'package:knu_app/screens/Widgets/timeTable.dart';
...
class _HeadPageState extends State<HeadPage>     with SingleTickerProviderStateMixin{
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      InkWell(
                        onTap: ()=> Navigator.push(context,  MaterialPageRoute(builder:
                            (context)=>GetTimetable('timetable')),),
        ...
        drawer:Drawer(
          ...
          child: ListView(
            ...
            children: <Widget>[
              ...
              ListTile(
                title: const Text('Assign Timetable'),
                leading: IconButton(
